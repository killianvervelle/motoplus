...
const DropdownMenu = ({ list }: { list: ListItem[] }) => {
  ...
  return (
    <div className='relative inline-block text-left text-text-light' ref={menuRef}>
      <button
        type='button'
        className='inline-flex w-full justify-center gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold shadow-md ring-1 ring-inset ring-[#c5c4c4] cursor-pointer'
        onClick={() => {
