        ...
        <div className='row'>
          <div className='col-11 sm:col-9 md:col-7 mx-auto'>
            ...
            <div className='flex gap-x-2 text-sm md:text-base mt-2'>
              <p className='text-text-light dark:text-darkmode-text-light'>Have an account?</p>
              <Link className='underline font-medium text-text-dark dark:text-darkmode-text-dark' href={'/login'}>
                Login
              </Link>
            </div>
          </div>
